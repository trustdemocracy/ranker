...
public class CalculateRankTest {
  ...
  @Test
  public void calculatePageRank2() {
    val user1 = users.get("user1");
    val user2 = users.get("user2");
    val user3 = users.get("user3");
    ...
    assertEquals(0.333, rank1, 0.001);
    assertEquals(0.333, rank2, 0.001);
    assertEquals(0.333, rank3, 0.001);
  }

  @Test
  public void calculatePageRank3() {
    val user1 = users.get("user1");
    val user2 = users.get("user2");
    val user3 = users.get("user3");
    ...
    assertEquals(0.215, rank1, 0.001);
    assertEquals(0.569, rank2, 0.001);
    assertEquals(0.215, rank3, 0.001);
  }
